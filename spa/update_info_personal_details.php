			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="card" style="border-top:2px solid #087ec2;">
					...
					<ul class="nav nav-tabs">
								<li class="nav-item">
									<a class="nav-link active" href="update_info_personal_details.php" id="navtabs">Update Personal Details</a>
								</li>
								<li class="nav-item">
								...
								<div class="row justify-content-center">
									<div class="col-sm-5 col-sm-5">
										<div class="card" style="border-top:2px solid #087ec2;">
											...
											<div class="card-body" style="height: 225px">
												<form action="import_personal_details.php" method="post" enctype="multipart/form-data">
												<!-- batch -->
									...
									<div class="col-sm-5 col-sm-5">
										<div class="card" style="border-top:2px solid #087ec2;">
											...
											<div class="card-body" style="height: 225px">
												<form action="export_personal_details.php" method="post" enctype="multipart/form-data">
													<!-- export -->
													<div class="form-group">
