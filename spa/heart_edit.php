...
<body>
				...
				<div class="card" style="border-top:2px solid #087ec2;">
					...
					<div class="card-body">
						...
						<ul class="nav nav-tabs">
							...
							<li class="nav-item">
								<a class="nav-link active" href="heart_edit.php" id="navtabs" >Heart</a>
							</li>
							<li class="nav-item">
					...
					<div class="card-footer">
						...
						<a href="heart_register.php" class="btn btn-success " style="float: right;"><i class="fa fa-user-plus"></i>&nbsp; Add</a>
					</div>
				</div>
			</div>
		</div>
	...
	<script>
		$(document).ready(function(){
		 	$("#output").load("heart_edit_table.php");
			});
