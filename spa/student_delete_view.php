...
<body>
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="card" style="border-top:2px solid #087ec2;">
					<div class="card-header bg-light" style="height: 45px;">
						<h6 class="card-title card-text"><i class="fa fa-edit"></i> <span>Edit Admin</span></h6>
					</div>
					<div class="card-body">
						...
						<ul class="nav nav-tabs">
							<li class="nav-item">
								<a class="nav-link active" href="admin_edit.php" id="navtabs">Admin</a>
							</li>
							<li class="nav-item">
							...
							<li class="nav-item">
								<a class="nav-link" href="head_edit.php" id="cnavtabs">Head</a>
							</li>
						</ul><br><br>
					...
					<div class="card-footer">
						...
						<a href="admin_register.php" class="btn btn-success " style="float: right;"><i class="fa fa-user-plus"></i>&nbsp; Add</a>
					</div>
				</div>
			</div>
		</div>
	...
	<script>
		$(document).ready(function(){
		 	$("#output").load("student_delete_table.php");
			});
