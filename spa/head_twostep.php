...
$sql = "SELECT otp,email FROM head_login WHERE user_name = '$uname'";
...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	if(empty(trim($_POST["user_dob"])))
	{
        ...
        echo'alert("Please enter a Date of Birth."); location.href="head_twostep.php"';
        echo '</script>';
        $err_dob = "yes";
	...
	{
		echo '<script language="javascript">';
        echo'alert("Invalid Date of Birth."); location.href="head_twostep.php"';
        echo '</script>';
        $err_dob = "yes";		
	}
	else
	...
	{
		echo '<script language="javascript">';
        echo'alert("Please enter a OTP."); location.href="head_twostep.php"';
        echo '</script>';
        $err_otp = "yes";
	}
	...
	{
		echo '<script language="javascript">';
        echo'alert("Invalid OTP."); location.href="head_twostep.php"';
        echo '</script>';
        $err_otp = "yes";		
	}
	else
