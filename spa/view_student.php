			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="card" style="border-top:2px solid #087ec2;">
					<div class="card-header bg-light" style="height: 45px;">
						<h6 class="card-title card-text"><i class="fa fa-eye"></i> <span>View Student</span></h6>
					</div>
						<div class="card-body">
								...
								<table class="table table-bordered table-hover">
									...
									<tbody>
										...
										?>
												...
												<td>
													<form action="view_student_report.php" method="post">
														<input type="hidden" name="rollno" value="<?php echo $row["roll_no"]; ?>">
														<button type="submit" name="view"class="btn btn-sm btn-success"><i class = "fa fa-eye"></i>
													</form>
												</td>
												</tr>
										<?php
