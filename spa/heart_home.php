		...
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="card" style="border-top:2px solid #087ec2;">
				<div class="card-header bg-light" style="height: 45px;">
					<h6 class="card-title card-text"><i class="fa fa-home fa-lg"></i> <span>Home :: Welcome to VIVEKANANDA COLLEGE - Heart Portal</span></h6>
				</div>
				<div class="card-body">
					...
					<a  class="btn btn-success btn-lg" href="update_gurukula_refinements.php" role="button" id="btnas"><i class="fa fa-bell fa-3x" aria-hidden="ture" id="faicon"></i>&nbsp; <spam id="btnlabaa">Gurukula <br>Refinements</spam></a><br><br>
